...
SCRIPTSDIR="$HOME/.config/hypr-lua/scripts"
wallpaper_current="$HOME/.config/hypr-lua/wallpaper_effects/.wallpaper_current"
...
modify_startup_config() {
  ...
  local startup_config="$HOME/.config/hypr-lua/UserConfigs/Startup_Apps.conf"
